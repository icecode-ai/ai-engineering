...
5. `安装` 模块：安装方式，用户agent内，告诉 agent `Fetch and follow instructions from https://raw.githubusercontent.com/doersoul/ai-engineering/refs/heads/main/INSTALL_4_{xxx}.md` , 支持 `INSTALL_4_CLAUDE.md`、`INSTALL_4_OPENCODE.md`、`INSTALL_4_QODER.md`
